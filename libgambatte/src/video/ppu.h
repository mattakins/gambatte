...
class PPUFrameBuf {
public:
	PPUFrameBuf() : buf_(0), fbline_(nullfbline()), pitch_(0), depth_(0), depthline_(0), bg_buf_(0), bg_bufline_(0) {}
	...
	video_pixel_t * bgbufline() const { return bg_bufline_; }
...
private:
	...
	uint8_t *depth_;
	uint8_t *depthline_;
	video_pixel_t *bg_buf_;
	video_pixel_t *bg_bufline_;
...
public:
   ...
   bool inDmgMode() const { return p_.dmgMode; }
	...
	void setBgBuffer(video_pixel_t *buf) { p_.framebuf.setBgBuf(buf); }
